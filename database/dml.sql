...
(1, 'Peanuts'), (2, 'Dairy'), (3, 'Gluten'), (4, 'Shellfish');

INSERT INTO Dietary_Preferences (Preference_ID, Preference_Name) VALUES
(1, 'Vegetarian'), (2, 'Vegan'), (3, 'Low-Carb'), (4, 'Pescatarian');

INSERT INTO Ingredients (Ingredient_ID, Name, Unit) VALUES
(1, 'Chicken Breast', 'grams'), (2, 'Brown Rice', 'grams'), (3, 'Broccoli', 'grams'),
(4, 'Teriyaki Sauce', 'ml'), (5, 'Lentils', 'grams'), (6, 'Vegetable Broth', 'ml'),
(7, 'Onion', 'pcs'), (8, 'Carrot', 'pcs'), (9, 'Quinoa', 'grams'), (10, 'Cucumber', 'pcs'),
(11, 'Cherry Tomatoes', 'grams'), (12, 'Lemon Vinaigrette', 'ml');
...
INSERT INTO Customer_Allergies (Customer_ID, Allergy_ID) VALUES (101, 1);
INSERT INTO Customer_Allergies (Customer_ID, Allergy_ID) VALUES (102, 2);
INSERT INTO Customer_Preferences (Customer_ID, Preference_ID) VALUES (102, 1);
...
(1001, 1, 1), (1001, 3, 1), (1002, 2, 1), (1002, 3, 1);
